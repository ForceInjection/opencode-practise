...
首次使用需要配置模型提供商。启动 OpenCode 后，在 TUI 中运行：

```bash
/connect
```

选择你的提供商并粘贴 API Key。新用户推荐使用 [OpenCode Zen](https://opencode.ai/zen)，提供开箱即用的精选模型。
